...
// Source: github.com/frankyhq/go-shopify-graphql/v9 (interfaces: OrderService)
...
import (
	...
	shopify "github.com/frankyhq/go-shopify-graphql/v9"
...
func (m *MockOrderService) CaptureTransaction(arg0 context.Context, arg1 model.OrderCaptureInput) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CaptureTransaction", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// CaptureTransaction indicates an expected call of CaptureTransaction.
func (mr *MockOrderServiceMockRecorder) CaptureTransaction(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CaptureTransaction", reflect.TypeOf((*MockOrderService)(nil).CaptureTransaction), arg0, arg1)
}
...
func (m *MockOrderService) VoidTransaction(arg0 context.Context, arg1 model.OrderCaptureInput) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VoidTransaction", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// VoidTransaction indicates an expected call of VoidTransaction.
func (mr *MockOrderServiceMockRecorder) VoidTransaction(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VoidTransaction", reflect.TypeOf((*MockOrderService)(nil).VoidTransaction), arg0, arg1)
}
